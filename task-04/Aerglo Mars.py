...
parser.add_argument("--api_key",default='nc3SBY9y0M2hiReQoFhfgScDpJfKH8ERD1EJbvVz', type=str, help="Your API key")
parser.add_argument("--earth_date",default="2015-06-03", type=str, help="Date in YYYY-MM-DD")
parser.add_argument("--rover_id",default= 6, type=int, help="5: Curiosity 6: Opportunity 7: Spirit")
...
parsed_requests = json.loads(response.text)
images_saved=0
if 'error' in parsed_requests:
    ...
    for photo in parsed_requests['photos']:
        if rover_id == photo['rover']['id']:
            ...
            photo_path = open(f"mars_photo{images_saved+1}.png", "wb")
